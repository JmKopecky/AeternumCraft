...
public class EffectsRegister {
    ...
    final String antigravityUUID = "7a0f334e-41e0-488c-a27c-650e0a89dba8";
    final String hypergravityUUID = "4a5ac8eb-960c-41ba-89bd-af77b03a0249";
    ...
    public static final RegistryObject<MobEffect> Antigravity = EFFECT.register("antigravity", () -> new AntigravityEffect(MobEffectCategory.NEUTRAL, 3124687).addAttributeModifier(ForgeMod.ENTITY_GRAVITY.get(), "7a0f334e-41e0-488c-a27c-650e0a89dba8", -0.1 , AttributeModifier.Operation.MULTIPLY_TOTAL));
    public static final RegistryObject<MobEffect> HyperGravity = EFFECT.register("hypergravity", () -> new HyperGravityEffect(MobEffectCategory.NEUTRAL, 3124687).addAttributeModifier(ForgeMod.ENTITY_GRAVITY.get(), "4a5ac8eb-960c-41ba-89bd-af77b03a0249", 0.1 , AttributeModifier.Operation.MULTIPLY_TOTAL));
