...
public class SpellScatterProjectileRenderer extends ArrowRenderer<SpellScatterProjectile> {
    ...
    public SpellScatterProjectileRenderer(EntityRendererProvider.Context manager) {
        super(manager);
        RenderSystem.setShaderColor(0, 0.5F, 1, 1);
    }

    public ResourceLocation getTextureLocation(SpellScatterProjectile spell) {
        return TEXTURE;
    }

    @Override
    public void render(SpellScatterProjectile pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
        RenderSystem.setShaderColor(0, 0.5F, 1, 1);
