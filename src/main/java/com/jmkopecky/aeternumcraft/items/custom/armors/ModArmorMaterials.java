...
import com.jmkopecky.aeternumcraft.items.ItemsRegister;
...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    /*
    Format:
    Name (String), Durability Multiplier (Int value, true durability varies per slot.), Protection/armor values (Int array),
    Enchant value (Int), Equip sound (SoundEvents.CHOOSESOUNDEVENT), Armor toughness (Float), Knockback Resistance (Float),
    Repair material ( () -> { return Ingredient.of(ItemsRegister.INGOT_ITEM.get()); }
    ...
    */
    ...
    GENTINIUM("gentinium", 39, new int[]{4, 7, 9, 4}, 20, SoundEvents.ARMOR_EQUIP_GENERIC, 2.0F, 0.2F, () -> {
        return Ingredient.of(ItemsRegister.GENTINIUM_INGOT.get());
    }),
    MONTENITE("montenite", 41, new int[]{6, 9, 11, 6}, 21, SoundEvents.ARMOR_EQUIP_GENERIC, 3.0F, 0.3F, () -> {
        return Ingredient.of(ItemsRegister.MONTENITE_INGOT.get());
    }),
    RECLINITE("reclinite", 44, new int[]{8, 11, 13, 8}, 22, SoundEvents.ARMOR_EQUIP_GENERIC, 5.0F, 0.4F, () -> {
        return Ingredient.of(ItemsRegister.RECLINITE_INGOT.get());
    }),
    RUELANITE("ruelanite", 48, new int[]{10, 13, 15, 10}, 23, SoundEvents.ARMOR_EQUIP_GENERIC, 6.0F, 0.5F, () -> {
